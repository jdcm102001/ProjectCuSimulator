            ...
            <div class="analytics-widget-content">
                ...
                <div class="analytics-row">
                    ...
                    <div class="analytics-card" id="pnlCard">
                        <div class="analytics-card-header">
                            ...
                            <span class="analytics-card-title">P&L BREAKDOWN</span>
                        </div>
                        ...
                        <div class="analytics-pnl-section">
                            ...
                            <div class="analytics-pnl-sublabel">At current spot - may change</div>
                        </div>
                    ...
                    <div class="analytics-card" id="spreadCard">
                        <div class="analytics-card-header">
                            <span class="analytics-card-icon">🔀</span>
                            <span class="analytics-card-title">SPREAD</span>
                        </div>
                        <div class="analytics-spread-main" id="spreadHigher">COMEX > LME</div>
                ...
                <div class="analytics-row">
                    ...
                    <div class="analytics-card" id="statusCard">
                        <div class="analytics-card-header">
                            <span class="analytics-card-icon">📍</span>
                            <span class="analytics-card-title">POSITION STATUS</span>
                        </div>
